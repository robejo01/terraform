...
resource "bigip_ltm_virtual_server" "test-appzones03" {
  name                       = "/${element(var.partitions, 1)}/Test-AppzoneS03"
  source                     = "0.0.0.0/0"
  ...
  pool                       = "/${element(var.partitions, 1)}/Test-AppzoneS03-Pool"
...
resource "bigip_ltm_pool" "az_pool" {
  name                = "/${element(var.partitions, 1)}/Test-AppzoneS03-Pool"
