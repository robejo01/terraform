...
resource "null_resource" "appzone-farm" {
  ...
  provisioner "local-exec" {
    command = <<EOT
  curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"farmname":"dev-appzones01","profile":"http","vip":"${var.az_vint_ip}","vport":"443"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms
EOT
  }
}
...
resource "null_resource" "farmsvc_restart-2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"action":"restart"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01/actions
EOT
  }
}
...
resource "null_resource" "appzone-farmcert" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"file":"${var.az_certname}"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01/certificates
EOT
  }
}
...
resource "null_resource" "appzone_service" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"id":"appzones01-svc"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01/services
EOT
  }
}
...
resource "null_resource" "appzone_svcmod" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"vhost":"${var.az_vhostname}"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01/services/appzones01-svc
EOT
  }
}
...
resource "null_resource" "appzone_bkend1" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.az_bkend1_ip}","port":${var.az_bkend_port},"weight":2,"timeout":15}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01/services/appzones01-svc/backends
EOT
  }
}
...
resource "null_resource" "appzone_bkend2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.az_bkend2_ip}","port":${var.az_bkend_port},"weight":2,"timeout":15}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01/services/appzones01-svc/backends
EOT
  }
}
...
resource "null_resource" "appzone-check" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"name":"check_appzone"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01/services/appzones01-svc/fg
EOT
  }
}
...
resource "null_resource" "appzone-redir-farm" {
  ...
  provisioner "local-exec" {
    command = <<EOT
  curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"farmname":"dev-appzones01-redir","profile":"http","vip":"${var.az_vint_ip}","vport":"80"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms
EOT
  }
}
...
resource "null_resource" "appzone_redir_service" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"id":"appzones01-redir-svc"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01-redir/services
EOT
  }
}
...
resource "null_resource" "farmsvc_restart-9" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"action":"restart"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01-redir/actions
EOT
  }
}
...
resource "null_resource" "appzone__redir_svcmod" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"vhost":"${var.az_vhostname}","redirect":"${var.az_redirurl}","redirecttype":"default"}' https://zenlb01.mgmt.tsafe.systems:444/zapi/v4.0/zapi.cgi/farms/dev-appzones01-redir/services/appzones01-redir-svc
EOT
  }
}
