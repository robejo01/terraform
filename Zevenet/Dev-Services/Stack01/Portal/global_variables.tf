...
terraform {
  backend "consul" {
    ...
    scheme       = "http"
    path         = "tf-legacy/state/krkld/infrastructure/zevenet/dev-services/stack01/dev-portals01"
...
variable "udx_certname" {
  type    = "string"
  default = "portals01.dev.tsafe.systems.pem"
}

variable "udx_vhostname" {
  type    = "string"
  default = "portals01.dev.tsafe.systems"
}

variable "udx_redirurl" {
  type    = "string"
  default = "https://portals01.dev.tsafe.systems"
}
