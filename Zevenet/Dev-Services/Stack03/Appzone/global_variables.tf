#############################################
#                                           #
#    DEVS03 Appzone - Zen/Zevenet Farm      #
#                                           #
#                                           #
#                                           #
#############################################
...
terraform {
  backend "consul" {
    ...
    scheme       = "http"
    path         = "tf-legacy/state/krkld/infrastructure/zevenet/dev-services/stack03/appzone"
...
variable "az_certname" {
  type    = "string"
  default = "appzones03.dev.tsafe.systems.pem"
}

variable "az_vhostname" {
  type    = "string"
  default = "appzones03.dev.tsafe.systems"
}

variable "az_redirurl" {
  type    = "string"
  default = "https://appzones03.dev.tsafe.systems"
}

variable "az_bkend1_ip" {
  type    = "string"
  default = "192.168.15.190"
}

variable "az_bkend2_ip" {
  type    = "string"
  default = "192.168.15.191"
}
