...
terraform {
  backend "consul" {
    ...
    scheme       = "http"
    path         = "tf-legacy/state/krkld/infrastructure/zevenet/dev-services/stack02/appzone"
...
variable "az_certname" {
  type    = "string"
  default = "appzones02.dev.tsafe.systems.pem"
}

variable "az_vhostname" {
  type    = "string"
  default = "appzones02.dev.tsafe.systems"
}

variable "az_redirurl" {
  type    = "string"
  default = "https://appzones02.dev.tsafe.systems"
}
