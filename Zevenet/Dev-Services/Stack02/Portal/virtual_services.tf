...
resource "null_resource" "udx-farm" {
  ...
  provisioner "local-exec" {
    command = <<EOT
  curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"farmname":"dev-portals02","profile":"http","vip":"${var.udx_vint_ip}","vport":"443"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms
EOT
  }
}
...
resource "null_resource" "farmsvc_restart-2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"action":"restart"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02/actions
EOT
  }
}
...
resource "null_resource" "udx-farmcert" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"file":"${var.udx_certname}"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02/certificates
EOT
  }
}
...
resource "null_resource" "udx_service" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"id":"portals02-svc"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02/services
EOT
  }
}
...
resource "null_resource" "udx_svcmod" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"vhost":"${var.udx_vhostname}"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02/services/portals02-svc
EOT
  }
}
...
resource "null_resource" "udx_bkend1" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.udx_bkend1_ip}","port":${var.udx_bkend_port},"weight":2,"timeout":5}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02/services/portals02-svc/backends
EOT
  }
}
...
resource "null_resource" "udx_bkend2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.udx_bkend2_ip}","port":${var.udx_bkend_port},"weight":2,"timeout":5}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02/services/portals02-svc/backends
EOT
  }
}
...
resource "null_resource" "udx-check" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"name":"check_udx"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02/services/portals02-svc/fg
EOT
  }
}
...
resource "null_resource" "udx-redir-farm" {
  ...
  provisioner "local-exec" {
    command = <<EOT
  curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"farmname":"dev-portals02-redir","profile":"http","vip":"${var.udx_vint_ip}","vport":"80"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms
EOT
  }
}
...
resource "null_resource" "udx_redir_service" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"id":"portals02-redir-svc"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02-redir/services
EOT
  }
}
...
resource "null_resource" "farmsvc_restart-9" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"action":"restart"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02-redir/actions
EOT
  }
}
...
resource "null_resource" "udx_redir_svcmod" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"vhost":"${var.udx_vhostname}","redirect":"${var.udx_redirurl}","redirecttype":"default"}' https://zenlb01.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/dev-portals02-redir/services/portals02-redir-svc
EOT
  }
}
