...
terraform {
  backend "consul" {
    ...
    scheme       = "http"
    path         = "tf-legacy/state/krkld/infrastructure/zevenet/dev-services/stack02/dev-portals02"
...
variable "udx_certname" {
  type    = "string"
  default = "portals02.dev.tsafe.systems.pem"
}

variable "udx_vhostname" {
  type    = "string"
  default = "portals02.dev.tsafe.systems"
}

variable "udx_redirurl" {
  type    = "string"
  default = "https://portals02.dev.tsafe.systems"
}
