#############################################
#                                           #
#    DEVS01 Appzone - Zen/Zevenet Farm      #
#                                           #
#                                           #
#                                           #
#############################################
...
terraform {
  backend "consul" {
    ...
    scheme       = "http"
    path         = "tf-legacy/state/krkld/infrastructure/zevenet/test-services/stack03/appzone"
...
variable "az_certname" {
  type    = "string"
  default = "appzones03.test.tsafe.systems.pem"
}

variable "az_vhostname" {
  type    = "string"
  default = "appzones03.test.tsafe.systems"
}

variable "az_redirurl" {
  type    = "string"
  default = "https://appzones03.test.tsafe.systems"
}
