...
terraform {
  backend "consul" {
    ...
    scheme       = "http"
    path         = "tf-legacy/state/krkld/infrastructure/zevenet/test-services/stack01/portal"
...
variable "udx_certname" {
  type    = "string"
  default = "portals01.test.tsafe.systems.pem"
}

variable "udx_vhostname" {
  type    = "string"
  default = "portals01.test.tsafe.systems"
}

variable "udx_redirurl" {
  type    = "string"
  default = "https://portals01.test.tsafe.systems"
}

variable "udx_bkend1_ip" {
  type    = "string"
  default = "192.168.15.52"
}

variable "udx_bkend2_ip" {
  type    = "string"
  default = "192.168.15.53"
}
