...
resource "null_resource" "bd-farm" {
  ...
  provisioner "local-exec" {
    command = <<EOT
  curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"farmname":"test-bdispatchs01","profile":"http","vip":"${var.bd_vint_ip}","vport":"38040"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms
EOT
  }
}
...
resource "null_resource" "farmsvc_restart-2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"action":"restart"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bdispatchs01/actions
EOT
  }
}
...
resource "null_resource" "bd_service" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"id":"bdispatchs01-svc"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bdispatchs01/services
EOT
  }
}
...
resource "null_resource" "bd_svcmod" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"vhost":"${var.bd_vhostname}","leastresp":"true"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bdispatchs01/services/bdispatchs01-svc
EOT
  }
}
...
resource "null_resource" "bd_bkend1" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.bd_bkend1_ip}","port":${var.bd_bkend_port},"weight":2,"timeout":15}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bdispatchs01/services/bdispatchs01-svc/backends
EOT
  }
}
...
resource "null_resource" "bd_bkend2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.bd_bkend2_ip}","port":${var.bd_bkend_port},"weight":2,"timeout":15}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bdispatchs01/services/bdispatchs01-svc/backends
EOT
  }
}
...
resource "null_resource" "bd-check" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"name":"node_check"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bdispatchs01/services/bdispatchs01-svc/fg
EOT
  }
}
