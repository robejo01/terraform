#############################################
#                                           #
#    TestS01 Appzone - Zen/Zevenet Farm     #
#                                           #
#                                           #
#                                           #
#############################################
...
terraform {
  backend "consul" {
    ...
    scheme       = "http"
    path         = "tf-legacy/state/krkld/infrastructure/zevenet/test-services/stack01/appzone"
...
variable "az_certname" {
  type    = "string"
  default = "appzones01.test.tsafe.systems.pem"
}

variable "az_vhostname" {
  type    = "string"
  default = "appzones01.test.tsafe.systems"
}

variable "az_redirurl" {
  type    = "string"
  default = "https://appzones01.test.tsafe.systems"
}

variable "az_bkend1_ip" {
  type    = "string"
  default = "192.168.15.37"
}

variable "az_bkend2_ip" {
  type    = "string"
  default = "192.168.15.62"
}
