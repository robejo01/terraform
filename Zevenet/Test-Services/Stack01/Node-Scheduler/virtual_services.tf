...
resource "null_resource" "bs-farm" {
  ...
  provisioner "local-exec" {
    command = <<EOT
  curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"farmname":"test-bschedules01","profile":"http","vip":"${var.bs_vint_ip}","vport":"38050"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms
EOT
  }
}
...
resource "null_resource" "farmsvc_restart-2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"action":"restart"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bschedules01/actions
EOT
  }
}
...
resource "null_resource" "bs_service" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"id":"bschedules01-svc"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bschedules01/services
EOT
  }
}
...
resource "null_resource" "bs_svcmod" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X PUT -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"vhost":"${var.bs_vhostname}","leastresp":"true"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bschedules01/services/bschedules01-svc
EOT
  }
}
...
resource "null_resource" "bs_bkend1" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.bs_bkend1_ip}","port":${var.bs_bkend_port},"weight":2,"timeout":15}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bschedules01/services/bschedules01-svc/backends
EOT
  }
}
...
resource "null_resource" "bs_bkend2" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"ip":"${var.bs_bkend2_ip}","port":${var.bs_bkend_port},"weight":2,"timeout":15}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bschedules01/services/bschedules01-svc/backends
EOT
  }
}
...
resource "null_resource" "bs-check" {
  ...
  provisioner "local-exec" {
    command = <<EOT
    curl -s -i -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: "${var.api_key}"" -d '{"name":"node_check"}' https://zenlb03.mgmt.company.com:444/zapi/v4.0/zapi.cgi/farms/test-bschedules01/services/bschedules01-svc/fg
EOT
  }
}
